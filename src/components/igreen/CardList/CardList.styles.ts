export const cardListStyles = {
    ...
    item: {
        base: "flex items-center gap-3 md:gap-4 bg-white px-3.5 md:px-4.5 py-3 md:py-3.5",
        separator: "border-b border-border-muted",
    },
    icon: {
        container: "flex shrink-0 items-center justify-center size-8 md:size-9 rounded-sm bg-bg-primary-subtle border border-border-primary-muted",
